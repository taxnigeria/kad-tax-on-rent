  ...
  return (
    <div className="min-h-screen bg-[#F0FDF4] text-emerald-950 antialiased selection:bg-emerald-200 selection:text-emerald-900">
      ...
      <style jsx global>{`
        ...
        /* Added auto-scrolling animation for payment partners */
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="w-full overflow-hidden">
            <div className="auto-scroll flex gap-x-16 items-center whitespace-nowrap pb-2">
              <span className="text-xl font-semibold tracking-tight text-emerald-800 flex-shrink-0">INTERSWITCH</span>
              <span className="text-xl font-semibold tracking-tight text-emerald-800 flex-shrink-0">REMITA</span>
              <span className="text-xl font-semibold tracking-tight text-emerald-800 flex-shrink-0">PAYKADUNA</span>
              <span className="text-xl font-semibold tracking-tight text-emerald-800 flex-shrink-0">ZENITH BANK</span>
              <span className="text-xl font-semibold tracking-tight text-emerald-800 flex-shrink-0">ACCESS BANK</span>
              <span className="text-xl font-semibold tracking-tight text-emerald-800 flex-shrink-0">FIRST BANK</span>
              <span className="text-xl font-semibold tracking-tight text-emerald-800 flex-shrink-0">GTB</span>
              <span className="text-xl font-semibold tracking-tight text-emerald-800 flex-shrink-0">UBA</span>
              <span className="text-xl font-semibold tracking-tight text-emerald-800 flex-shrink-0">ECOBANK</span>
              <span className="text-xl font-semibold tracking-tight text-emerald-800 flex-shrink-0">KADIRS</span>
            ...
            {[
              {
                ...
                answer:
                  "Withholding Tax on Rent (WHT) is a statutory tax obligation on rental income. Property owners and landlords are required to remit a percentage of rental income to the Kaduna State Internal Revenue Service.",
              },
              {
                question: "Who is required to pay Withholding Tax on Rent?",
                answer:
                  "All landlords and property owners who receive rental income within Kaduna State are required to register and pay Withholding Tax on Rent. This includes both residential and commercial properties.",
              },
              {
                question: "How do I register my property?",
                answer:
                  "Visit the registration section on our platform, provide your property details, upload supporting documents, and generate your assessment ID. Our instructional guide video walks you through each step.",
              },
              {
                question: "What documents do I need to register?",
                answer:
                  "Typically, you'll need proof of ownership, property photos, tenant information, lease agreements, and valid identification. Specific requirements may vary based on property type.",
              },
              {
                question: "How is Withholding Tax on Rent calculated?",
                answer:
                  "The tax is calculated using the official Kaduna State formula based on your annual rental income. Our platform automatically calculates accurate amounts - no manual calculations needed.",
              },
              {
                question: "Can I pay my tax online?",
                answer:
                  "Yes! We support payments through multiple channels including banks, payment gateways, and REMITA. All payment methods are secure and immediately confirmed.",
              },
              {
                question: "What if I don't pay my tax on time?",
                answer:
                  "Late payments may attract penalties and interest. We recommend paying before the deadline to avoid additional charges. You'll receive reminders through the platform.",
              },
              {
                question: "How do I get my assessment ID (KADIRS ID)?",
                answer:
                  "After registering and verifying your phone and email, you can generate your assessment ID. This ID is essential for all tax transactions and inquiries.",
              },
            ].map((faq, i) => (
              <details
                key={i}
